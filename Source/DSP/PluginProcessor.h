...
public:
    ...
    //=======================MIDI===================================================
    // ToDo: Change this to return false if MIDI is not finally used.
    /** Returns true. */
...
#pragma endregion
    ...
    //=======================DSP====================================================
#pragma region DSP
    //=======================Inherited from Audio processor=========================
public:
    /**
...
private:
    ...
    //==============================================================================
    /** Filters to go in the feedback loop */
    ///** Filter parameters */
    //dsp::StateVariableFilter::Parameters<float> filterParams;
    /** Left channel filter */
    dsp::StateVariableFilter::Filter<float> filter_L;
    /** Right channel filter */
    dsp::StateVariableFilter::Filter<float> filter_R;
    ...
    float getNoteDurationSeconds(String noteDuration);
